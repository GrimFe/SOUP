from SOUP.Serpent2InputWriter import Simulation
from SOUP.Serpent2InputWriter import Comment
from SOUP.Serpent2InputWriter.base import reformat
...
class Test_Simulation:
    ...
    def test_gcu(self) -> None:
        from SOUP.Serpent2InputWriter import Universe
